...
- [x] [Majority Element](https://leetcode.com/problems/majority-element/) @notdone
...
- [x] [Find the Duplicate Number](https://leetcode.com/problems/find-the-duplicate-number/)  [amazon]
